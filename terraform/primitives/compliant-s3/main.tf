...
provider "aws" {
  ...
  # CM-6: Configuration settings and required compliance
  # tags are applied to every taggable resource.
  default_tags {
    tags = {
...
# CM-6: Versioning preserves prior object states
...
# Explicitly block all four public-access mechanisms.
...
# AU-3 / AU-6: S3 access logging provides
# audit records for access to the primary bucket.
